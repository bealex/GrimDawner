...
public struct DevotionResolver {
    ...
    private struct Draft {
        ...
        public let given: [ResolvedConstellation.Affinity]
        public let required: [ResolvedConstellation.Affinity]
        ...
        public var isComplete: Bool { stars.allSatisfy(\.isTaken) }
    }

    public func map(from save: Gdc.SaveFile) -> DevotionMap {
    ...
    public func stats(from save: Gdc.SaveFile) -> StatBlock {
        var block = StatBlock()
