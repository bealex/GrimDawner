...
public extension ItemRoll {
    ...
    public struct Sources {
        public var base = Table()
        public var prefix: Table?
        public var suffix: Table?
        public var modifier: Table?
    ...
    public static func stats(of sources: Sources, drawing draws: Draws? = nil) -> [String: Double] {
    ...
    public static func petStats(of sources: [(table: Table, jitter: Double)], seed: UInt32) -> [String: Double] {
    ...
    private struct Pass {
        public let base: Table
        public let prefix: Table?
        public let suffix: Table?
        public let modifier: Table?

        public let baseJitter: Double
        public let prefixJitter: Double
        public let suffixJitter: Double
        public let modifierJitter: Double
        public let scale: Double

        public var random: Draws
        public var result = [String: Double]()
        public var handledDuration = Set<String>()
        public var earlySkill = [String: Double]()
        public var earlySkillDone: Bool
        public let prefixHasSkill: Bool
        public let suffixHasSkill: Bool

        public init(sources: Sources, draws: Draws, baseJitter: Double = ItemRoll.baseJitter) {
            base = sources.base
        ...
        public mutating func run() -> [String: Double] {
