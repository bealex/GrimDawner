...
public final class TextureStore: Sendable {
    ...
    public func image(at path: String) -> CGImage? {
    ...
    public func size(at path: String) -> CGSize? {
    ...
    public func prewarm(_ paths: some Sequence<String>) {
