...
public enum StatGroup: Int, CaseIterable, Sendable {
    case attributes
    case defence
    case resistances
...
public enum StatUnit: Sendable {
    ...
    public func format(_ value: Double, signed: Bool = true) -> String {
...
public struct StatDefinition: Sendable {
...
public enum StatCatalog {
    ...
    public static func definition(for key: String) -> StatDefinition? { byKey[key] }
