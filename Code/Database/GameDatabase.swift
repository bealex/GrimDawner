...
/// game itself uses.
final class GameDatabase: Sendable {
    ...
    func record(_ path: String) -> ArzRecord? {
    ...
    func text(_ tagKey: String) -> String {
    ...
    func localised(_ tagKey: String) -> String? {
    ...
    func sweep(prefix: String, _ body: (String, ArzRecord) -> Void) {
        var seen = Set<String>()
        for database in databases {
    ...
    func bitmap(inRecordAt path: String) -> String {
    ...
    private final class RecordCache: Sendable {
        ...
        struct Entry: Sendable { let record: ArzRecord? }
        ...
        func store(_ record: ArzRecord?, for key: String) {
