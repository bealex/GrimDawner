...
enum Texture {
    ...
    private struct Colour {
        ...
        static let transparent = Colour(red: 0, green: 0, blue: 0, alpha: 0)

        /// Mixes towards `other` in thirds, which is how BC blocks derive their two middle colours.
        func blended(towards other: Colour, thirds weight: Int) -> Colour {
        ...
        func midpoint(_ other: Colour) -> Colour {
            Colour(
    ...
    static func image(from raw: [UInt8]) throws -> CGImage {
        guard
