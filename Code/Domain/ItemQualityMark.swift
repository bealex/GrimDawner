...
enum ItemQualityMark: String, Sendable {
    ...
    var texturePath: String { "ui/character/\(rawValue).tex" }
    ...
    static func isGear(recordClass: String) -> Bool {
