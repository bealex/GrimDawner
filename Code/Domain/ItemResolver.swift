...
struct ItemResolver {
    ...
    func resolve(_ item: Gdc.Item) -> ResolvedItem? {
    ...
    func sets(worn items: [ResolvedItem]) -> [ResolvedSet] {
    ...
    static func itemName(of record: ArzRecord, in database: GameDatabase) -> String? {
        guard
    ...
    static func readableName(from path: String) -> String {
