...
extension ItemRoll {
    ...
    static let offensiveReflexFields = [
    ...
    static let offensiveSlowFields: [(field: String, scales: Bool)] = [
    ...
    static let chanceSplitFields: Set<String> = [
    ...
    static let leechFields = [ "offensiveLifeLeech" ]

    static let offensiveReductionFields = [
    ...
    static let retaliationFlatFields = [
    ...
    static let retaliationDurationFields = [
    ...
    static let retaliationDurationPercentFields = [ "retaliationSlowAttackSpeed", "retaliationSlowRunSpeed" ]

    static let retaliationModifierFields = [
    ...
    static let retaliationReflexFields = [ "retaliationStun", "retaliationFreeze", "retaliationConfusion" ]

    static let defenceFields = [
    ...
    static let conversionFields = [ "conversionPercentage", "conversionPercentage2" ]
    ...
    static let earlySkillFields: Set<String> = [ "skillCooldownReduction", "skillManaCostReduction" ]

    /// Crit and total damage never take the item's scale.
    static let nonScaling: Set<String> = [ "offensiveCritDamageModifier", "offensiveTotalDamageModifier" ]

    /// Shield block figures are read straight from the record: no roll, no draw.
    static let fixedBlockFields: Set<String> = [
        "defensiveBlock", "defensiveBlockChance", "blockAbsorption", "blockRecoveryTime",
    ]

    static let fixedFields: Set<String> = [
    ...
    static func isFixed(_ field: String) -> Bool {
