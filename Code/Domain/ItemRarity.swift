...
enum ItemRarity: Int, Comparable, Sendable {
    case broken = 0
    case common = 1
    case magical = 2
    case rare = 3
    ...
    static func < (lhs: ItemRarity, rhs: ItemRarity) -> Bool { lhs.rawValue < rhs.rawValue }
    ...
    var takesAffixes: Bool { self == .common || self == .magical || self == .rare }
}
