...
enum ItemRoll {
    ...
    struct Table {
        ...
        var isEmpty: Bool { values.isEmpty && text.isEmpty }

        func has(_ field: String) -> Bool { values[field] != nil }

        func value(_ field: String) -> Double { values[field] ?? 0 }
    }

    /// The jitter an item's own record rolls at. Affixes roll at their `lootRandomizerJitter`.
    static let baseJitter = 20.0
    ...
    enum Draws {
        ...
        mutating func step(within spread: Double) -> Double {
            switch self {
    ...
    static func jitterChar(_ value: Double, _ percent: Double, _ draws: inout Draws) -> Double {
    ...
    static func jitterSkill(_ value: Double, _ percent: Double, _ draws: inout Draws) -> Double {
    ...
    static func applyScale(_ rolled: Double, _ scalePercent: Double) -> Double {
    ...
    static func jitterConversion(_ value: Double, _ percent: Double, _ draws: inout Draws) -> Double {
    ...
    static func roundAway(_ value: Double) -> Double { value.rounded(.toNearestOrAwayFromZero) }
}
